...
function of_recognized_background_repeat() {
	...
	$default = array(
		'no-repeat' => __( 'No Repeat', 'the-church' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'the-church' ),
		'repeat-y'  => __( 'Repeat Vertically', 'the-church' ),
		'repeat'    => __( 'Repeat All', 'the-church' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'the-church' ),
		'top center'    => __( 'Top Center', 'the-church' ),
		'top right'     => __( 'Top Right', 'the-church' ),
		'center left'   => __( 'Middle Left', 'the-church' ),
		'center center' => __( 'Middle Center', 'the-church' ),
		'center right'  => __( 'Middle Right', 'the-church' ),
		'bottom left'   => __( 'Bottom Left', 'the-church' ),
		'bottom center' => __( 'Bottom Center', 'the-church' ),
		'bottom right'  => __( 'Bottom Right', 'the-church')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'the-church' ),
		'fixed'  => __( 'Fixed in Place', 'the-church')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'the-church' ),
		'italic'      => __( 'Italic', 'the-church' ),
		'bold'        => __( 'Bold', 'the-church' ),
		'bold italic' => __( 'Bold Italic', 'the-church' )
		);
